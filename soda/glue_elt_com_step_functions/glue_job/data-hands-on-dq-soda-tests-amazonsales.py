...
def main():
    ...
    df = read_data(spark, "s3://cjmm-datalake-curated/data-hands-on-df-soda-amazon-sales-obt")
    ...
    write_results_to_s3(spark, checks_data, schema, "s3://cjmm-datalake-curated/mds_data_quality_results/soda_amazonsales_spark")
