...
def main():
    ...
    df = spark.read.format("delta").load("s3://cjmm-datalake-staged/amazonsales_lakehouse/stg_amazonsales")
    ...
    write_data_parquet_delta(
        spark,
        df_dim_product,
        "s3://cjmm-datalake-curated/amazonsales_lakehouse/dim_product",
        "product_id",
    )
